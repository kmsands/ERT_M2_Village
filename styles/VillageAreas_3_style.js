var size = 0;
var placement = 'point';
function categories_VillageAreas_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'A Block':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(166,209,255,1.0)'}),
...
var style_VillageAreas_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("greater_block");
    var labelText = "";
    size = 0;
...
var style = categories_VillageAreas_3(feature, value, size, resolution, labelText,
